...
namespace IAproject.Controllers
{
    public class MenustestController : Controller
    {
        ...
        // GET: Menustest/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Menustest/Create
